...
public class UIControlsService
{
    ...
    private void NotifyModalChange()
    {
    ...
    {
        var modal = new ModalParameter
            {Class = null, Body = body, Footer = footer, Title = title, DisableBackgroundCancel = false};
        ModalParameter = modal;
    ...
    {
        var modal = new ModalParameter
            {Content = content, DisableBackgroundCancel = disableBackgroundCancel, Class = className};
        ModalParameter = modal;
        NotifyModalChange();
    }
}