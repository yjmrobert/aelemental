...
public struct AeStyleBuilder
{
    ...
    /// <summary>
    ///     Creates a StyleBuilder used to define conditional in-line style used in a component. Call Build() to return the
    ///     completed style as a string.
    /// </summary>
    /// <param name="prop"></param>
    /// <param name="value"></param>
    public static AeStyleBuilder Default(string prop, string value)
    {
    ...
    /// <param name="prop"></param>
    /// <param name="value"></param>
    public static AeStyleBuilder Default(string style)
    {
        return Empty().AddStyle(style);
    }
    ...
    ///     completed style as a string.
    /// </summary>
    public static AeStyleBuilder Empty()
    {
        return new();
    }
    ...
    /// <param name="prop"></param>
    /// <param name="value"></param>
    public AeStyleBuilder(string prop, string value)
    {
    ...
    public AeStyleBuilder AddStyle(string style)
    {
        return !string.IsNullOrWhiteSpace(style) ? AddRaw($"{style};") : this;
    }
    ...
    /// <returns>StyleBuilder</returns>
    public AeStyleBuilder AddStyle(string prop, string value)
    {
        return AddRaw($"{prop}:{value};");
    }
    ...
    {
        return when ? AddStyle(prop, value) : this;
    }
    ...
    {
        return AddStyle(prop, value, when());
    }
    ...
    /// <returns>StyleBuilder</returns>
    public AeStyleBuilder AddStyle(AeStyleBuilder builder)
    {
        return AddRaw(builder.Build());
    }
    ...
    {
        return when ? AddRaw(builder.Build()) : this;
    }
    ...
    /// <returns>StyleBuilder</returns>
    public AeStyleBuilder AddStyle(AeStyleBuilder builder, Func<bool> when = null)
    {
        return AddStyle(builder, when());
    }
    ...
    {
        return additionalAttributes == null ? this :
    ...
    {
        foreach (var (prop, value) in additionalStyles) AddRaw($"{prop}: {value};");
...
public static class BuilderExtensions
{
    ...
    {
        return string.IsNullOrEmpty(classBuilder.ToString()) ? null : classBuilder.ToString();
    }
