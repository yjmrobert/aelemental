...
public struct AeCssClassBuilder
{
    ...
    /// <summary>
    ///     Sets the prefix value to be appended to all classes added following the this statement. When SetPrefix is called it
    ///     will overwrite any previous prefix set for this instance. Prefixes are not applied when using AddValue.
    /// </summary>
    ...
    /// </summary>
    /// <param name="value"></param>
    public static AeCssClassBuilder Default(string value)
    {
        return new(value);
    }
    ...
    ///     Call Build() to return the completed CSS Classes as a string.
    /// </summary>
    public static AeCssClassBuilder Empty()
    {
        return new();
    }
    ...
    /// <returns>AeCssBuilder</returns>
    public AeCssClassBuilder AddClass(string value)
    {
    ...
    /// <returns>AeCssBuilder</returns>
    public AeCssClassBuilder AddClass(string value, bool when = true)
    {
        return when ? AddClass(value) : this;
    }
    ...
    /// <param name="when">Condition in which the CSS Class is added.</param>
    /// <returns>AeCssBuilder</returns>
    public AeCssClassBuilder AddClass(string value, Func<bool> when = null)
    {
    ...
    /// <param name="when">Condition in which the CSS Class is added.</param>
    /// <returns>AeCssBuilder</returns>
    public AeCssClassBuilder AddClass(Func<string> value, bool when = true)
    {
        return when ? AddClass(value()) : this;
    }
    ...
    /// <param name="when">Condition in which the CSS Class is added.</param>
    /// <returns>AeCssBuilder</returns>
    public AeCssClassBuilder AddClass(Func<string> value, Func<bool> when = null)
    {
        return AddClass(value, when());
    }
    ...
    /// <param name="when">Condition in which the CSS Class is added.</param>
    /// <returns>AeCssBuilder</returns>
    public AeCssClassBuilder AddClass(AeCssClassBuilder classBuilder, bool when = true)
    {
        return when ? AddClass(classBuilder.Build()) : this;
    }
    ...
    /// <param name="when">Condition in which the CSS Class is added.</param>
    /// <returns>AeCssBuilder</returns>
    public AeCssClassBuilder AddClass(AeCssClassBuilder classBuilder, Func<bool> when = null)
    {
        return AddClass(classBuilder, when());
    }
